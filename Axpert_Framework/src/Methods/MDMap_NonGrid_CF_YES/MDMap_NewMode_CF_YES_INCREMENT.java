...
public class MDMap_NewMode_CF_YES_INCREMENT extends TestBase{
		
		public void MDMap_NewMode_INCR_CF_YES_ATMTrans() throws Exception
		{
			...
			selectDropDownValue(getWebElement("MDMap_ADD_AccountNo"), "005");
			...
			selectDropDownValue(getWebElement("MDMap_INC_IncUpdateType"), "YES");
		...
		//Checking Deposit value is Added in main Balance or not..
			...
			String ActualMainBalanceAfterIncrValue= getWebElement("MDMap_ADD_MastermainBalance").getAttribute("value");
