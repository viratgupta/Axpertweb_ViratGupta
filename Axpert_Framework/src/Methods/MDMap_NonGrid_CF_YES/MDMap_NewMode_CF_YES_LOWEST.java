...
public class MDMap_NewMode_CF_YES_LOWEST extends TestBase{
	
	public void MDMap_NewMode_LOW_CF_YES_ATMTrans() throws Exception
	{
		...
		selectDropDownValue(getWebElement("MDMap_LOW_LowestUpdateType"), "YES");
	...
	//Checking Deposit value is Added in main Balance or not..
		...
		System.out.println("Actual Main Balance After Low Value "+ActualMainBalanceAfterLowValue);
			...
			
		{
			...
			{
			System.out.println("Lower Balance after Trans is "+ mainbalance);
			System.out.println("TESTCASE PASS");
