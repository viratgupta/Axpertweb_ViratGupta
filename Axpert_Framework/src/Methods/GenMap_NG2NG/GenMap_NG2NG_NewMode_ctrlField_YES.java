...
public class GenMap_NG2NG_NewMode_ctrlField_YES extends TestBase {
	
	public void NG2NG_Master() throws Exception
	{
		...
		getWebElement("GenMap_NG2NG_CheckAll").click();
		
		getWebElement("GenMap_NG2NG_DeleteListview").click();
	...
	//Navigate to CHILD NG2NG GENMAP TSTRUCT WITH CF= YES
	...
	public void NG2NG_CheckMaster() throws Exception
	{
		...
		if(ActualRows.equalsIgnoreCase(ExpectedRows)){
			...
			System.out.println("TestCase PASS:::GENMAP NG2NG_NEW MODE_CTRL FIELD_YES");
