...
public class GenMap_NG2G_NewMode_ctrlField_YES extends TestBase {
	
	public void NG2G_Master() throws Exception
	{
		...
		getWebElement("GenMap_NG2G_CheckAll").click();
		
		getWebElement("GenMap_NG2G_DeleteListview").click();
	...
	//Navigate to CHILD NG2G GENMAP TSTRUCT WITH CF= YES
	...
	public void NG2G_CheckMaster() throws Exception
	{
		...
		if(ActualRows.equalsIgnoreCase(ExpectedRows)){
			...
			System.out.println("TestCase PASS:::GENMAP NG2G_NEW MODE_CTRL FIELD_YES");
