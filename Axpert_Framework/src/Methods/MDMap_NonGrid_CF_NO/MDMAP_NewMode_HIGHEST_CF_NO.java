...
public class MDMAP_NewMode_HIGHEST_CF_NO extends TestBase{
	
	public void MDMap_NewMode_HIGH_CF_NO_ATMTrans() throws Exception
	{
		...
		selectDropDownValue(getWebElement("MDMap_HIGH_HighestUpdateType"), "NO");
	...
	//Checking Deposit value is Added in main Balance or not In Master Transaction page..
