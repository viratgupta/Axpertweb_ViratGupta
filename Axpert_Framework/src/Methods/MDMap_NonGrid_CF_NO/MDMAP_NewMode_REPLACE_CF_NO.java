...
public class MDMAP_NewMode_REPLACE_CF_NO extends TestBase {
	
	public void MDMap_NewMode_REPLACE_CF_NO_ATMTrans() throws Exception
	{
		...
		selectDropDownValue(getWebElement("MDMap_ReplaceUpdateType"), "NO");
