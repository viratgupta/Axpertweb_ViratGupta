...
public class MDMAP_NewMode_DECREMENT_CF_NO extends TestBase {
	
	public void MDMap_NewMode_DECR_CF_NO_ATMTrans() throws Exception
	{
		...
		selectDropDownValue(getWebElement("MDMap_DEC_DecUpdateType"), "NO");
