...
public class MDMAP_NewMode_INCREMENT_CF_NO extends TestBase {

	public void MDMap_NewMode_INCR_CF_NO_ATMTrans() throws Exception
	{
		...
		selectDropDownValue(getWebElement("MDMap_INC_IncUpdateType"), "NO");
