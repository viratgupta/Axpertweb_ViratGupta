...
public class MDMap_G2G_NewMode_CF_NO_ADD extends TestBase {
	
	public void MDMap_G2G_NewMode_ADD_CF_NO_ATMTrans() throws Exception
	{
	...
	//Checking Deposit value is Added in main Balance or not..
		...
		if(ActualMainbalanceafter== mainbalance)
		{
			...
			System.out.println("Expected Result: "+mainbalance+" Actual Result: "+mainbalance);
