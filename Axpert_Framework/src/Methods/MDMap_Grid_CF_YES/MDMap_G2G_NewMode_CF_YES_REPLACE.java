...
public class MDMap_G2G_NewMode_CF_YES_REPLACE extends TestBase {
	
	public void MDMap_G2G_NewMode_REPLACE_CF_YES_ATMTrans() throws Exception
	{
	...
	//Checking Deposit value is Added in main Balance or not..
		...
		if(ActualMainbalanceafter== ReplaceBalance)
